...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tbuser Read</h2>
        <table class="table">
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('tbuser') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>
...
<?php
/* End of file tbuser/tbuser_read */
/* Location: ./application/views/tbuser/tbuser_read */
