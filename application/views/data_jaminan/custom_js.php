    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var t = $("#mytable").dataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: {"url": "data_jaminan/json", "type": "POST"},
                columns: [
                    {
                        "data": "kdJaminan",
                        "orderable": false
                    },{"data": "penjamin"},{"data": "nilai"},{"data": "tgl"},{"data": "Type"},{"data": "kdpaket"},
                    {
                        "data" : "action",
                        "orderable": false,
...
<?php
/* End of file data_jaminan/custom_js.php */
/* Location: ./application/view/data_jaminan/custom_js.php */
