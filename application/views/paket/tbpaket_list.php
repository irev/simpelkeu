...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <?php echo anchor('paket/intro/','<i class="fa fa-plus"></i> Paket',array('class'=>'btn btn-success btn-sm'));?>
            ...
            if($this->ion_auth->is_admin()){
                ...
                foreach ($bidang as $bid) {
                    ...
                    if($bid->name != 'admin' && $bid->name != 'members'){
                        ...
                        echo ' '.anchor('paket?bidang='.$bid->id, $bid->name,array('class'=>'btn '.$btn.' btn-sm'));
        ...
        <!--a href="#" class="btn" onclick="konfirmasiDelete()">konfirmasiDelete</a-->
