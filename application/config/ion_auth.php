 ...
 */
$config['site_title']                 = "simpelkeu";       // Site Title, example.com
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com
$config['default_group']              = 'bidang';           // Default group, use name
...
$config['max_password_length']        = 20;                   // max_password_length Required Length of Password (not enforced by lib - see note above)
